...
QUEST_DATA["20"] := Map("Name", "Hatch Best Egg", "Regex", "i)your.*bes", "Status", "Auto", "Zone", "Void")
...
QUEST_DATA["34-2"] := Map("Name", "Use Tier 4 Potions", "Regex", "i)(.*(iv|lv).*pot|^use.*pot)", "Status", "Auto", "Zone", "-")
...
QUEST_DATA["38"] := Map("Name", "Break Comets in Best Area", "Regex", "i)(comet|cornet).*best", "Status", "Auto", "Zone", "Best")
